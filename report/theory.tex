...
磁場とスピンの相互作用のHamiltonianは(6)式より
\begin{equation}
...
と修正できる。この方程式を解くと
\begin{equation}
N = A\exp\left(-\frac{t}{\tau}\right)\exp\left(-\frac{1}{2\omega\tau}\sin\omega t\right)
\end{equation}
となる。ただし、$A$は次元を持たない定数である。
